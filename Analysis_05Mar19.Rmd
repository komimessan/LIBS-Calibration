...
m_zinc_0 <- average(Raw_zinc_0[(Raw_zinc_0$Wavelength==334.534),])$v_m
m_zinc_100 <- average(Raw_zinc_100[(Raw_zinc_100$Wavelength==334.534),])$v_m
m_zinc_250 <- average(Raw_zinc_250[(Raw_zinc_250$Wavelength==334.534),])$v_m
m_zinc_500 <- average(Raw_zinc_500[(Raw_zinc_500$Wavelength==334.534),])$v_m
m_zinc_1000 <- average(Raw_zinc_1000[(Raw_zinc_1000$Wavelength==334.534),])$v_m


sd_zinc_0 <- average(Raw_zinc_0[(Raw_zinc_0$Wavelength==334.534),])$v_sd
sd_zinc_100 <- average(Raw_zinc_100[(Raw_zinc_100$Wavelength==334.534),])$v_sd
sd_zinc_250 <- average(Raw_zinc_250[(Raw_zinc_250$Wavelength==334.534),])$v_sd
sd_zinc_500 <- average(Raw_zinc_500[(Raw_zinc_500$Wavelength==334.534),])$v_sd
sd_zinc_1000 <- average(Raw_zinc_1000[(Raw_zinc_1000$Wavelength==334.534),])$v_sd
...
fit_zinc <- lm(Mean_I~Concentration, data = zinc_uni_data) # Rsquare = 0.553
...
cali_plot_zn <- ggplot(zinc_uni_data, aes(x=Concentration, y=Mean_I)) +
  ...
  ylab("Intensity (a.u.)") +
  geom_label(x=0.2, y=200, label="Adj R2 = -0.31459") + 
  theme_bw() + p
